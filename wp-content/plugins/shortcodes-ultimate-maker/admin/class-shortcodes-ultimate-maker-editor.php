				...
				'l10n'       => array(
					...
					'Attributes' => array(
						...
						'item'    => array(
							...
							'label'          => __( 'Field label', 'shortcodes-ultimate-maker' ),
							'labelDesc'      => sprintf( __( 'This text will be used as field label in the Insert Shortcode window. %1$sLearn more%2$s.', 'shortcodes-ultimate-maker' ), '<a href=https://getshortcodes.com/docs/shortcode-creator-user-guide/#attributes" target="_blank">', '</a>' ),
							...
							'type'           => __( 'Field type', 'shortcodes-ultimate-maker' ),
							'typeDesc'       => sprintf( __( 'This setting indicates the field type which will be used in shortcode generator at insertion of shortcode to page editor. %1$sLearn more%2$s.', 'shortcodes-ultimate-maker' ), '<a href="https://getshortcodes.com/docs/shortcode-creator-user-guide/#attributes" target="_blank">', '</a>' ),
							'desc'           => __( 'Field description', 'shortcodes-ultimate-maker' ),
							'descDesc'       => sprintf( __( 'This text will be used as field description in the Insert Shortcode window. %1$sLearn more%2$s.', 'shortcodes-ultimate-maker' ), '<a href="https://getshortcodes.com/docs/shortcode-creator-user-guide/#attributes" target="_blank">', '</a>' ),
							'options'        => __( 'Dropdown options', 'shortcodes-ultimate-maker' ),
							'optionsDesc'    => sprintf( __( 'This text will be used to create dropdown options list. Each option must be placed on a separate line. Option values and labels must be separated with pipe symbol %1$s. %2$sLearn more%3$s.', 'shortcodes-ultimate-maker' ), '<code>|</code>', '<a href="https://getshortcodes.com/docs/shortcode-creator-user-guide/#attributes" target="_blank">', '</a>' ),
