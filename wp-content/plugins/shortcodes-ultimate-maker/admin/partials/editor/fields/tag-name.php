...
<p class="description sum-validation-message sum-validation-failed-message"><?php printf( __( 'Invalid shortcode tag name. Please use only allowed characters: %s', 'shortcodes-ultimate-maker' ), '<code><nobr>a-z, 0-9, _</nobr></code>' ); ?></p>
<p class="description sum-validation-message sum-validation-required-message"><?php _e( 'Shortcode tag name can not be empty.', 'shortcodes-ultimate-maker' ); ?></p>
