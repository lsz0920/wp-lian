 ...
 * @subpackage   Shortcodes_Ultimate_Skins/admin
 */
final class Shortcodes_Ultimate_Skins_Settings {
	...
	public function __construct( $plugin_file ) {
		...
		$this->addon_name = __( 'Additional Skins', 'shortcodes-ultimate-skins' );
		...
		$this->license_key_activation_messages = array(
			...
			// Activation messages
			'activated-202'             => __( 'License key successfully activated', 'shortcodes-ultimate-skins' ),
			'not-activated-400'         => __( 'Invalid license key', 'shortcodes-ultimate-skins' ),
			'not-activated-409'         => __( 'Invalid license key', 'shortcodes-ultimate-skins' ),
			'not-activated-500'         => __( 'Invalid license key', 'shortcodes-ultimate-skins' ),
			'not-activated-limit-403'   => __( 'License key reached it\'s activation limit. Deactivate this license key on other sites', 'shortcodes-ultimate-skins' ),
			'not-activated-product-403' => __( 'This license key is intended to use with another add-on', 'shortcodes-ultimate-skins' ),
			'not-activated-503'         => __( 'Unable to connect to activation server, please try again later', 'shortcodes-ultimate-skins' ),
			'not-activated-001'         => __( 'Unknown error', 'shortcodes-ultimate-skins' ),

			// Deactivation messages
			'deactivated-202'           => __( 'License key successfully deactivated', 'shortcodes-ultimate-skins' ),
			'not-deactivated-400'       => __( 'Invalid license key', 'shortcodes-ultimate-skins' ),
			'not-deactivated-409'       => __( 'Invalid license key', 'shortcodes-ultimate-skins' ),
			'not-deactivated-500'       => __( 'Invalid license key', 'shortcodes-ultimate-skins' ),
			'not-deactivated-503'       => __( 'Unable to connect to activation server, please try again later', 'shortcodes-ultimate-skins' ),
			'not-deactivated-001'       => __( 'Unknown error', 'shortcodes-ultimate-skins' ),
	...
	public function register_settings() {
		...
		add_settings_field(
			...
			__( 'License key', 'shortcodes-ultimate-skins' ),
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_style(
			'shortcodes-ultimate-skins-settings',
		...
		if ( empty( $value ) ) {
			...
			if ( 'deactivated-202' !== $status ) {
				...
				$message['text'] .= sprintf(
					...
					__( 'error code', 'shortcodes-ultimate-extra' ),
					$message['id']
				);
