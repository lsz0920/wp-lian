          ...
          <div class="sl-clinic-inn-content-wr">
            ...
            <div class="d-fl sl-clinic-inn-content-wr-imgs">
              <div class="sl-clinic-inn-content-wr-imgs-item">
                <figure>
                  <img src="<?php echo get_template_directory_uri(); ?>/img/clinic/clinic-dir-01.png" alt="clinic">
                </figure>
                <p>横浜駅中央西口を出ます</p>
              </div>
              <div class="sl-clinic-inn-content-wr-imgs-item">
                <figure>
                  <img src="<?php echo get_template_directory_uri(); ?>/img/clinic/clinic-dir-02.png" alt="clinic">
                </figure>
                <p>階段を上がった後に矢印の方向に進みます</p>
              </div>
              <div class="sl-clinic-inn-content-wr-imgs-item">
                <figure>
                  <img src="<?php echo get_template_directory_uri(); ?>/img/clinic/clinic-dir-03.png" alt="clinic">
                </figure>
                <p>矢印の方向へ進みます</p>
              </div>
              <div class="sl-clinic-inn-content-wr-imgs-item">
                <figure>
                  <img src="<?php echo get_template_directory_uri(); ?>/img/clinic/clinic-dir-04.png" alt="clinic">
                </figure>
                <p>三菱UFJ銀行を右手に進みます</p>
              </div>
              <div class="sl-clinic-inn-content-wr-imgs-item">
                <figure>
                  <img src="<?php echo get_template_directory_uri(); ?>/img/clinic/clinic-dir-05.png" alt="clinic">
                </figure>
                <p>カラオケビッグエコーがある横断歩道を右折します</p>
              </div>
              <div class="sl-clinic-inn-content-wr-imgs-item">
                <figure>
                  <img src="<?php echo get_template_directory_uri(); ?>/img/clinic/clinic-dir-06.png" alt="clinic">
                </figure>
                <p>真っ直ぐ進みます</p>
              </div>
              <div class="sl-clinic-inn-content-wr-imgs-item">
                <figure>
                  <img src="<?php echo get_template_directory_uri(); ?>/img/clinic/clinic-dir-07.png" alt="clinic">
                </figure>
                <p>松屋が入っているビルの2階となります</p>
              </div>
              <div class="sl-clinic-inn-content-wr-imgs-item">
                <figure>
                  <img src="<?php echo get_template_directory_uri(); ?>/img/clinic/clinic-dir-08.png" alt="clinic">
                </figure>
