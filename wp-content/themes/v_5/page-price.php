...
<div class="mainImg fullH">
	<div class="bg fullH">
		<picture>
			<source srcset="<?php echo get_template_directory_uri(); ?>/renew2025/img/lian-reserve/price/main_img_sp.jpg" media="(max-width: 999px)">
			<img data-skip-lazy src="<?php echo get_template_directory_uri(); ?>/renew2025/img/lian-reserve/price/main_img.jpg" alt="">
		</picture>
	</div>
	<div class="textBg">
		<picture>
	...
	<h2><span class="en fadeTxt">PRICE</span><span class="jp">公平‧公正な価格で透明性のある<br class="sp">情報開示の徹底</span></h2>
...
<div class="mainBox" id="scroll">
	...
	<div class="comPrice">
		<section class="priceSec">
			...
			<?php if ( have_rows('ff_price_reserve','options') ) : ?>
			<p class="note fadeInUp">※価格は全て税込表記です。</p>
			<div class="whiteBg fadeInUp">
				<div class="content">
					<h4 class="headLine08">基本料金</h4>
					<?php while( have_rows('ff_price_reserve','options') ) : the_row();
		...
		<section class="priceSec">
			...
			if($terms2){
				foreach($terms2 as $term2) {
					...
					$priceQuery = new WP_Query($post_args2);
