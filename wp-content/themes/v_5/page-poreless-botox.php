...
<script type="application/ld+json">
  {
    ...
    "@type": "VideoObject",
    "name": "ポアレスボトックスの施術の流れ",
    "description": "ポアレスボトックスの施術の流れが分かる動画です。",
    "thumbnailUrl": "https://lianclinic.net/renew2022/wp-content/themes/v_2/img/sub-whatporeless-img01.png",
    "uploadDate": "2022-09-07T08:00:00+09:00",
    "duration": "PT10S",
    "contentUrl": "https://lianclinic.net/renew2022/wp-content/themes/v_2/video/poreless-state-video.mp4"
  }
</script>
        ...
        <div id="whatis" class="sl-whatis">
          <div class="sl-whatis-inn menu-inn attach-mv">
            <div class="sl-whatis-inn-ttl subpage-ttl menu-inn-ttl">
              <h1 class="under-line menu-inn-ttl__inner">ポアレスボトックスとは</h1>
            </div>
            <div class="sl-whatis-inn-content">
              <div class="fl-style02 d-fl">
                <div class="image">
                  <img loading="lazy" class="pc" src="<?php echo get_template_directory_uri(); ?>/img/sub-whatporeless-img01.png" alt="ポアレスボトックスとは">
                  <img loading="lazy" class="sp" src="<?php echo get_template_directory_uri(); ?>/img/sub-whatporeless-img01-sp.png" alt="ポアレスボトックスとは">
                </div>
                <div class="content">
                  <p>
              ...
              <div class="sv-info">
                ...
                <div class="doctor__comments">
                  ...
                  <p>ポアレスボトックスとは、ボトックスを皮内(浅め)に注入することで、皮脂の分泌を抑制し、毛穴の開きを抑制する施術です。<br>皮脂が出やすく、テカりが気になる方、鼻や頬の毛穴の開きが気になる方などはおすすめの治療となります。</p>
                </div>
        ...
        <div id="benefits" class="sl-benefits">
          <div class="menu-inn sl-benefits-inn">
            <div class="sl-benefits-inn-ttl subpage-ttl menu-inn-ttl">
              <h2 class="under-line">ポアレスボトックスの<br class="sp">効果<br class="sp"><small>（改善できる症状）</small></h2>
            </div>
