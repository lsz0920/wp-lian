        ...
        <div id="whatis" class="sl-whatis">
          <div class="menu-inn sl-whatis-inn attach-mv">
            <div class="sl-whatis-inn-ttl subpage-ttl menu-inn-ttl">
              <h1 class="under-line menu-inn-ttl__inner">リップアートメイクとは</h1>
            </div>
            <div class="sl-whatis-inn-content">
              <div class="d-fl whatis-detailup">
                <figure>
                  <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/lips/sub-whatislip-img01.png" alt="リップアートメイクとは">
                </figure>
              ...
              <div class="d-fl whatis-detailbot">
                ...
                <figure>
                  <img loading="lazy" class="pc" src="<?php echo get_template_directory_uri(); ?>/img/sub-whatis-img-02.jpg" alt="what is">
                  <img loading="lazy" class="sp" src="<?php echo get_template_directory_uri(); ?>/img/sub-whatis-img-sp-02.png" alt="what is">
                </figure>
              </div>
            </div>
            <div class="sv-info">
                ...
                <div class="doctor__comments">
                  ...
                  <p>リップは印象を変える重要なパーツです。当院ではお客様のお悩みやなりたいお色をヒアリングして、自然なリップに仕上げております。アートメイク看護師はすべて3000例以上経験しているトップアーティストのみ所属しております。リップのくすみが気になる、素顔に自信がない方などはぜひ当院のアートメイクをご経験ください。</p>
                </div>
          ...
          <div class="menu-inn sl-problems-inn">
            ...
            <div class="sl-problems-inn-content">
              ...
              <div class="problems-bg">
                <figure>
                  <img loading="lazy" class="pc" src="<?php echo get_template_directory_uri(); ?>/img/menu/menu-links-lip.png" alt="menu">
                  <img loading="lazy" class="sp" src="<?php echo get_template_directory_uri(); ?>/img/sub-problems-bg.png" alt="menu">
                </figure>
                <figure class="sp menu-links-sp">
                  <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/menu/menu-links-lip-sp.png" alt="menu">
                </figure>
              </div>
              <div class="pg-text">
              ...
              <div class="fl-style01">
                <article class="fl-style01-item">
                  ...
                  <div class="d-fl fl-style01-item-content">
                    <figure>
                      <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/lips/lip-problems-img01.png" alt="lip problems">
                    </figure>
                ...
                <article class="fl-style01-item">
                  <h2 class="fl-style01-item-ttl"><span class="list-no"><strong>02</strong></span>唇の血色を良く見せたい</h2>
                  <div class="d-fl fl-style01-item-content">
                    <figure>
                      <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/lips/lip-problems-img02.png" alt="lip problems">
                    </figure>
                    <div class="fl-style01-item-content-txt">
                ...
                <article class="fl-style01-item">
                  <h2 class="fl-style01-item-ttl"><span class="list-no"><strong>03</strong></span>リップラインを<br class="sp">くっきりさせたい</h2>
                  <div class="d-fl fl-style01-item-content">
                    <figure>
                      <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/lips/lip-problems-img03.png" alt="lip problems">
                    </figure>
                    <div class="fl-style01-item-content-txt">
                ...
                <article class="fl-style01-item">
                  <h2 class="fl-style01-item-ttl"><span class="list-no"><strong>04</strong></span>唇に厚みを持たせたい</h2>
                  <div class="d-fl fl-style01-item-content">
                    <figure>
                      <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/lips/lip-problems-img04.png" alt="lip problems">
                    </figure>
                    <div class="fl-style01-item-content-txt">
                ...
                <article class="fl-style01-item">
                  <h2 class="fl-style01-item-ttl"><span class="list-no"><strong>05</strong></span>口角を上げたい</h2>
                  <div class="d-fl fl-style01-item-content">
                    <figure>
                      <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/lips/lip-problems-img05.png" alt="lip problems">
                    </figure>
                    <div class="fl-style01-item-content-txt">
                ...
                <article class="fl-style01-item">
                  <h2 class="fl-style01-item-ttl"><span class="list-no"><strong>06</strong></span>すっぴんでも自信を持ちたい</h2>
                  <div class="d-fl fl-style01-item-content">
                    <figure>
                      <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/lips/lip-problems-img06.png" alt="lip problems">
                    </figure>
                    <div class="fl-style01-item-content-txt">
              ...
              <div class="list-style01">
                ...
                <div class="list-style01-item">
                  ...
                  <div class="list-style01-item-txt">
                    ...
                    <div class="disc-list">
                      <ul class="disc-list-wr">
                        <li>アートメイクの専用針が清潔でなかった</li>
                        <li>設備の衛生管理が不十分だった</li>
                        <li>注入するインク自体に安全面の問題があった</li>
                      </ul>
                    </div>
            ...
            <div class="sl-disadvantage-inn-content">
              ...
              <div class="fl-style01">
                <article class="fl-style01-item">
                  ...
                  <div class="d-fl fl-style01-item-content">
                    <figure>
                      <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/lips/lip-disadvantage-img01.png" alt="disadvantage">
                    </figure>
                    <div class="fl-style01-item-content-txt">
                      <p>
                ...
                <article class="fl-style01-item">
                  ...
                  <div class="d-fl fl-style01-item-content">
                    <figure>
                      <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/lips/lip-disadvantage-img02.png" alt="disadvantage">
                    </figure>
                    <div class="fl-style01-item-content-txt">
          ...
          <div class="menu-inn sl-pain-inn">
            ...
            <div class="sl-pain-inn-content">
              <div class="d-fl pain-fl">
                <figure>
                  <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/lips/pain-img.png" alt="施術中の痛みについて">
                </figure>
                <div class="pain-txt">
                  <p>アートメイクは施術部位によって痛みの程度が異なりますが、<span class="color-02"><strong>リップは皮膚がとても薄く痛みを比較的感じやすい部位</strong></span>となります。</p>
                  <p>通常、リップアートメイクの際には1種類の麻酔のみを使用するクリニックがほとんどですが、<strong>私たちLIANクリニックではアートメイクの施術の際に2種類の麻酔を使用し、痛みを抑えた施術を実現しています。</strong></p>
          ...
          <div class="menu-inn sl-downtime-inn">
            ...
            <div class="sl-downtime-inn-content">
              ...
              <div class="disc-list">
                <ul class="disc-list-wr">
                  <li>激しい運動は控える</li>
                  <li>できるだけこすらない、触らない</li>
                  <li>メイクはNG</li>
                  <li>毎日ワセリンなどで念入りに保湿</li>
                </ul>
              </div>
              <div class="pg-text">
            ...
            <div class="sl-clinic-inn-content">
              ...
              <div class="fl-style01">
                <article class="fl-style01-item">
                  ...
                  <div class="d-fl fl-style01-item-content">
                    <figure>
                      <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/lips/lip-clinic-img01.png" alt="カウンセリングを徹底しているクリニック">
                    </figure>
                    <div class="fl-style01-item-content-txt">
                ...
                <article class="fl-style01-item">
                  ...
                  <div class="d-fl fl-style01-item-content">
                    <figure>
                      <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/lips/lip-clinic-img02.png" alt="実績が多く症例写真を確認できるクリニック">
                    </figure>
                    <div class="fl-style01-item-content-txt">
                ...
                <article class="fl-style01-item">
                  ...
                  <div class="d-fl fl-style01-item-content">
                    <figure>
                      <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/lips/lip-clinic-img03.png" alt="アフターフォローが充実しているクリニック">
                    </figure>
                    <div class="fl-style01-item-content-txt">
              ...
              <div class="fl-style04">
                <article>
                  <a class="fl-style04-fl d-fl" target="_blank" rel="nofollow noreferrer">
                    <figure>
                      <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/case/lip-case01.png" alt="症例写真">
                    </figure>
                    <div class="content">
                      <dl>
                        <dt>施術名</dt>
                ...
                <article>
                  <a class="fl-style04-fl d-fl" target="_blank" rel="nofollow noreferrer">
                    <figure>
                      <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/case/lip-case02.png" alt="症例写真">
                    </figure>
                    <div class="content">
                      <dl>
                        <dt>施術名</dt>
                ...
                <article>
                  <a class="fl-style04-fl d-fl" target="_blank" rel="nofollow noreferrer">
                    <figure>
                      <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/case/lip-case03.png" alt="症例写真">
                    </figure>
                    <div class="content">
                      <dl>
                        <dt>施術名</dt>
            ...
            <div class="sl-flow-inn-content">
              ...
              <div class="d-fl fl-style03">
                <article class="fl-style03-item">
                  ...
                  <figure>
                    <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/menu-02/lip-flow01.png" alt="flow">
                  </figure>
                ...
                <article class="fl-style03-item">
                  ...
                  <figure>
                    <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/menu-02/lip-flow02.png" alt="flow">
                  </figure>
                ...
                <article class="fl-style03-item">
                  ...
                  <figure>
                    <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/menu-02/lip-flow03.png" alt="flow">
                  </figure>
                ...
                <article class="fl-style03-item">
                  ...
                  <figure>
                    <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/menu-02/lip-flow04.png" alt="flow">
                  </figure>
                  <p>
                    多くのお客様が気にされる「施術時の痛み」についてですが、当院では<strong>2種類の表面麻酔</strong>を使用しており、痛みを抑えた施術を目指しています。（多くのクリニックでは1種類の麻酔のみ使用）
                ...
                <article class="fl-style03-item">
                  ...
                  <figure>
                    <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/menu-02/lip-flow05.png" alt="flow">
                  </figure>
                ...
                <article class="fl-style03-item">
                  ...
                  <figure>
                    <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/menu-02/lip-flow06.png" alt="flow">
                  </figure>
        ...
        <div id="connection" class="">
          <div class="menu-inn">
            ...
            <div class="sl-connection-inn-content">
              ...
              <?php get_template_part('template-parts/service/artmake'); ?>
