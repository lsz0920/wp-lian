    ...
    <div id="menu"  class="sl-menu menu-hifulinear">
      <div class="sl-menu-content">
          ...
          <div class="sl-whatis-inn menu-inn attach-mv">
            ...
            <div class="sl-whatis-inn-content">
              <div class="fl-style02 d-fl align-center">
                <div class="image">
                  <img loading="lazy" class="pc" src="<?php echo get_template_directory_uri(); ?>/img/sub-whathifulinear-img01.png" alt="HIFUリニア (脂肪溶解HIFU) とは">
                  <img loading="lazy" class="sp" src="<?php echo get_template_directory_uri(); ?>/img/sub-whathifulinear-img01-sp.png" alt="HIFUリニア (脂肪溶解HIFU) とは">
                </div>
                <div class="content">
              ...
              <div class="fl-style02 d-fl align-center">
                <div class="image">
                  <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/sub-whathifulinear-img02.png" alt="HIFUリニア (脂肪溶解HIFU) とは">
                </div>
                <div class="content content02">
                  <h3>リニアモードで施術をしていきます</h3>
              ...
              <div class="sv-info">
                ...
                <div class="doctor__comments">
                  ...
                  <p>ハイフリニアは、特にあご下やあご周り、フェイスラインの皮下脂肪の多い箇所に効果的です。二重顎の改善やお顔の脂肪を減らし、引き締めることで小顔効果が得られ、若返った印象を与えることができます。</p>
                </div>
          ...
          <div class="menu-inn sl-recommended-inn">
            ...
            <div class="sl-recommended-inn-content">
              <div class="fl-style02 d-fl row-reverse">
                <div class="image">
                  <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/recommend/hifulinear-recommend01.png" alt="HIFUリニアはこのような方にオススメ">
                </div>
                <div class="content">
                  <p>打つ箇所<br>
              ...
              <div class="pg-text">
                <p>頻度・回数<br>
                  ハイフリニアは基本的に2〜3週に1回、最低計3回は行うのをおすすめしています。3回分を1クールと考えて、効果を実感できた方はもう1クールと続けていく流れが一般的です。</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="sl-features-inn-content">
              <div class="fl-style03 d-fl">
                <article class="fl-style03-item">
                  ...
                  <figure>
                    <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/features/hifu-feature01.png" alt="LIANの３つの特徴">
                  </figure>
                ...
                <article class="fl-style03-item">
                  ...
                  <figure>
                    <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/features/hifu-feature02.png" alt="LIANの３つの特徴">
                  </figure>
                </article>
                <article class="fl-style03-item">
                  <h3><span class="list-no">03</span><small>お悩みに合わせた</small><br>カスタマイズハイフ</h3>
                  <figure>
                    <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/features/hifu-feature03.png" alt="LIANの３つの特徴">
                  </figure>
                </article>
              </div>
            </div>
            ...
            <div class="sl-treatment-inn-content">
              <div class="fl-style02 d-fl">
                ...
                <div class="content content01">
                  <h3>サーマジェン</h3>
                  <p>HIFUリニアよりも浅い層がターゲットである、サーマジェンを併用することで、HIFUリニアの小顔効果に加えて、引き締め効果を期待できます。HIFUリニアとサーマジェンの併用治療である「ハイサーマ」という治療を行っているのでおすすめです。</p>
                </div>
              </div>
              <div class="fl-style02 d-fl row-reverse">
                <div class="image">
                  <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/treatment/treatment03.png" alt="脂肪溶解注射">
                </div>
                <div class="content content01">
                  <h3>脂肪溶解注射</h3>
              ...
              <div class="fl-style02 d-fl">
                <div class="image">
                  <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/treatment/treatment04.png" alt="ショートスレッド">
                </div>
                <div class="content content01">
                  <h3>ショートスレッド</h3>
                  <p>皮膚に吸収される（約6~8ヶ月）過程で皮下組織に刺激を与え続け、創傷治癒効果をもたらし長期的なコラーゲン生成により、【たるみ改善、新細胞による肌質の向上や弾力アップ、毛穴改善】が見込めます。</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div id="price" class="sl-price">
          <div class="menu-inn sl-price-inn">
            ...
            <div class="sl-price-inn-content">
              <div class="price">
                <h3 class="price-ttl"><span>ハイフリニア</span></h3>
        ...
        <div id="connection" class="">
          <div class="menu-inn">
            <div class="sl-connection-inn-ttl subpage-ttl menu-inn-ttl "><h2 class="under-line">小顔になるのに効果的な治療</h2></div>
            <div class="sl-connection-inn-content">

              <?php get_template_part('template-parts/service/botox'); ?>
              <?php get_template_part('template-parts/service/fat-dissolve'); ?>
