...
<script type="application/ld+json">
	{
		...
		"@type": "VideoObject",
		"name": "ニードルRF（サーマニードル）の施術の流れ",
		"description": "ニードルRF（サーマニードル）の施術の流れが分かる動画です。",
				...
				<div id="whatis" class="sl-whatis">
					<div class="sl-whatis-inn menu-inn attach-mv">
						<div class="sl-whatis-inn-ttl subpage-ttl menu-inn-ttl">
							<h1 class="under-line menu-inn-ttl__inner">ニードルRF（サーマニードル）とは</h1>
						</div>
						<div class="sl-whatis-inn-content">
							...
							<figure class="image">
								<img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/sub-whatneedle_rf-img01.png" alt="ニードルRF（サーマニードル）とは">
							</figure>
						</div>
					</div>
				</div>
				<div id="benefits" class="sl-benefits">
					<div class="menu-inn sl-benefits-inn">
						<div class="sl-benefits-inn-ttl subpage-ttl menu-inn-ttl">
							<h2 class="under-line">ニードルRF（サーマニードル）の効果<br class="sp"><small>（改善できる症状）</small></h2>
						</div>
				...
				<div id="differences" class="sl-differences">
					<div class="menu-inn sl-differences-inn">
						...
						<div class="sl-differences-inn-content">
							<div class="pg-text">
								<p>ダーマペンは穴をあけてニキビ跡や毛穴を入れていく治療で、針を刺して穴をあけるという点では同じですが、ニードルRF（サーマニードル）は穴をあけてさらに熱を加えるので、ピンポイントでの治療ができより高い治療効果が期待できます。</p>
								<p>ニードルRF（サーマニードル）は熱を加えることと穴を開けることの両方が一度にできますが、皮膚の奥の層に熱を加えるため表面はダウンタイムがほとんどなく年齢や肌タイプを選ばない治療です。皮膚が薄くなる比較的年齢層が上の方も安心してお受けいただけます。</p>
							</div>
						</div>
					</div>
				</div>
				<div id="state" class="sl-state">
					<div class="menu-inn sl-state-inn">
						...
						<div class="sl-state-inn-content video-style01">
							<iframe width="100%" height="100%" src="https://www.youtube.com/embed/Ut2L2SHQivg" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
						</div>
					</div>
				</div>
					...
					<div class="menu-inn sl-treatment-inn">
						...
						<div class="sl-treatment-inn-content">
							<div class="fl-style02 d-fl">
								<div class="image">
									<img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/treatment/treatment06.png" alt="サーマジェン">
								</div>
				...
				<div id="price" class="sl-price">
					<div class="menu-inn sl-price-inn">
						...
						<div class="sl-price-inn-content">
							<div class="price">
								<h3 class="price-ttl"><span>マイクロニードルRF（サーマニードル）</span></h3>
				...
				<div id="precautions" class="sl-precautions">
					<div class="menu-inn sl-precautions-inn">
						<div class="sl-precautions-inn-ttl subpage-ttl menu-inn-ttl">
							<h2 class="under-line">ニードルRF（サーマニードル）の注意事項</h2>
						</div>
