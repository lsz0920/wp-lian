  ...
  <main id="main" class="site-main sl">
    ...
    <div id="booking" class="sl-booking">
      <div class="sl-booking-inn">
        <div class="sl-booking-inn-ttl subpage-ttl subpage-ttl02">
          <?php $locale = get_locale();
          if ('en_US' == $locale) { ?>
            <h1 class="under-line">Reserve</h1>
          <?php } else { ?>
            <h1 class="under-line">ご予約について</h1>
          <?php } ?>
        </div>
        <div class="sl-booking-inn-content">
          <div class="sl-booking-inn-content-img sl-booking-inn-content-img-p-60">
            <?php if ('en_US' == $locale) { ?>
              <picture>
                <source srcset="<?php echo get_template_directory_uri(); ?>/img/access/access-top-en.webp"
                  media="(min-width: 769px)">
                <img src="<?php echo get_template_directory_uri(); ?>/img/access/access-top-en_sp.webp"
                  alt="lian clinicの受付の写真" width="315" height="274" loading="lazy">
              </picture>
            <?php } else { ?>
              <picture>
                <source srcset="<?php echo get_template_directory_uri(); ?>/img/access/access-top.webp"
                  media="(min-width: 769px)">
                <img src="<?php echo get_template_directory_uri(); ?>/img/access/access-top_jp_sp.webp"
                  alt="LIAN clinicの受付の写真" width="315" height="274" loading="lazy">
              </picture>
            <?php } ?>
          </div>
