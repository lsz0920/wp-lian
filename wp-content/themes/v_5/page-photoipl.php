          ...
          <div class="sl-whatis-inn menu-inn attach-mv">
            ...
            <div class="sl-whatis-inn-content">
              <div class="fl-style02 d-fl">
                <div class="image">
                  <img loading="lazy" class="pc" src="<?php echo get_template_directory_uri(); ?>/img/sub-whatphotoipl-img01.png" alt="フォトiplとは">
                  <img loading="lazy" class="sp" src="<?php echo get_template_directory_uri(); ?>/img/sub-whatphotoipl-img01-sp.png" alt="フォトiplとは">
                </div>
                <div class="content">
              ...
              <div class="image-center">
                ...
                <figure>
                  <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/sub-whatphotoipl-img02.png" alt="光治療とレーザー治療　違いのイメージ">
                </figure>
              </div>
              <div class="sv-info">
                ...
                <div class="doctor__comments">
                  ...
                  <p>
                    IPL（Intense Pulsed Light）は、複数の波長の光を肌に照射する光治療です。
                    <br>IPL治療では、メラニン色素やヘモグロビンにダメージを与え、コラーゲンの再生・増加を促します。シミ、そばかす、赤ら顔、にきび、肌の赤み、小じわやたるみ、毛穴の開きなど、顔全体の若返り効果があります。
                    <br>当院では、ソバカスや赤みに有効な「シミ取りIPL(アキュプラス)」とトーンアップ効果や肌のハリを出す「トーンアップIPL(アキュライト)」があります。
                    <br>また、その2つを組み合わせた「強力シミ取りIPL」があります。目のキワまで当てられるので、目周りのシミが気になるお客様にもおすすめです。
                  </p>
                </div>
          ...
          <div class="menu-inn sl-benefits-inn">
            ...
            <div class="sl-benefits-inn-content">
              <ul class="circle-fl01 d-fl">
                ...
                <li class="plus">
                  <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/plus-icon01.svg" alt="Plus">
                </li>
                <li class="circle">
                  <div>
                ...
                <li class="equal">
                  <img loading="lazy" class="pc" src="<?php echo get_template_directory_uri(); ?>/img/equal-icon01.svg" alt="Equal">
                  <img loading="lazy" class="sp" src="<?php echo get_template_directory_uri(); ?>/img/equal-icon01-sp.svg" alt="Equal">
                </li>
              ...
              <div class="fl-style04">
                <article>
                  <a class="fl-style04-fl d-fl" target="_blank" rel="nofollow noreferrer">
                    <figure>
                      <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/case/photoipl-case01.png" alt="症例写真">
                    </figure>
                    <div class="content">
                      <dl>
                        <dt>施術名</dt>
