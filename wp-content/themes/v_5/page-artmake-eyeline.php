          ...
          <div class="menu-inn sl-whatis-inn attach-mv">
            ...
            <div class="sl-whatis-inn-content">
              <div class="d-fl whatis-detailup">
                <figure>
                  <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/sub-whatiseyeliner-img01.png" alt="アイラインアートメイクとは">
                </figure>
              ...
              <div class="d-fl whatis-detailbot">
                ...
                <figure>
                  <img loading="lazy" class="pc" src="<?php echo get_template_directory_uri(); ?>/img/sub-whatislip-img02.jpg" alt="アートメイクは皮膚のごく浅い部分である表皮に色素を注入">
                  <img loading="lazy" class="sp" src="<?php echo get_template_directory_uri(); ?>/img/sub-whatislip-img02-sp.png" alt="アートメイクは皮膚のごく浅い部分である表皮に色素を注入">
                </figure>
              </div>
            </div>
            <div class="sv-info">
                ...
                <div class="doctor__comments">
                  ...
                  <p>アイラインは印象を変える重要なパーツです。アートメイク看護師はすべて3000例以上経験しているトップアーティストのみ所属しております。メイクが面倒という方、素顔に自信がない方などはぜひ当院のアートメイクをご経験ください。</p>
                </div>
              ...
              <div class="fl-style01">
                <article class="fl-style01-item">
                  ...
                  <div class="d-fl fl-style01-item-content">
                    <figure>
                      <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/benefits/eyeliner-benefits-img01.png" alt="目力UP">
                    </figure>
                ...
                <article class="fl-style01-item">
                  ...
                  <div class="d-fl fl-style01-item-content">
                    <figure>
                      <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/benefits/eyeliner-benefits-img02.png" alt="アイメイクのテクニックが">
                    </figure>
                    <div class="fl-style01-item-content-txt">
                ...
                <article class="fl-style01-item">
                  ...
                  <div class="d-fl fl-style01-item-content">
                    <figure>
                      <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/benefits/eyeliner-benefits-img03.png" alt="メイク時間を大幅に短縮">
                    </figure>
                    <div class="fl-style01-item-content-txt">
                ...
                <article class="fl-style01-item">
                  ...
                  <div class="d-fl fl-style01-item-content">
                    <figure>
                      <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/benefits/eyeliner-benefits-img04.png" alt="すっぴんに抵抗がなくなる">
                    </figure>
                    <div class="fl-style01-item-content-txt">
            ...
            <div class="sl-failcase-inn-content">
              ...
              <div class="disc-list">
                <ul class="disc-list-wr">
                  <li>除去するには特殊な施術（レーザー除去）が必要</li>
                  <li>自然に消えるまでに長い期間がかかる</li>
                </ul>
              </div>
              <div class="pg-text">
                <p>となります。<br>
          ...
          <div class="menu-inn sl-pain-inn">
            ...
            <div class="sl-pain-inn-content">
              <div class="d-fl pain-fl">
                <figure>
                  <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/menu-03/pain-img.png" alt="施術中の痛みについて">
                </figure>
                <div class="pain-txt">
                  <p>アイラインアートメイクは、粘膜に近い場所の施術となるため <span class="color-02"><strong>痛みを比較的感じやすい</strong></span>のが特徴です。</p>
                  <p>ですが、アイラインアートメイク施術は麻酔をした上で行うため、それほど心配するような痛みのレベルではありません。多くのクリニックでは麻酔を1種類使用するのに対し、<strong>私たちLIANクリニックでは2種類の麻酔を使用し痛みを抑えた施術を実現しています。</strong></p>
            ...
            <div class="sl-clinic-inn-content">
              ...
              <div class="fl-style01">
                <article class="fl-style01-item">
                  ...
                  <div class="d-fl fl-style01-item-content">
                    <figure>
                      <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/eyeline/eyeliner-howto-img01.png" alt="カウンセリングを">
                    </figure>
                    <div class="fl-style01-item-content-txt">
                ...
                <article class="fl-style01-item">
                  ...
                  <div class="d-fl fl-style01-item-content">
                    <figure>
                      <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/eyeline/eyeliner-howto-img02.png" alt="実績が多く症例写真を">
                    </figure>
                    <div class="fl-style01-item-content-txt">
                ...
                <article class="fl-style01-item">
                  ...
                  <div class="d-fl fl-style01-item-content">
                    <figure>
                      <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/eyeline/eyeliner-howto-img03.png" alt="アフターフォローが">
                    </figure>
                    <div class="fl-style01-item-content-txt">
                      <p>
              ...
              <div class="fl-style04">
                <article>
                  <a class="fl-style04-fl d-fl" target="_blank" rel="nofollow noreferrer">
                    <figure>
                      <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/case/eye-case01.png" alt="症例写真">
                    </figure>
                    <div class="content">
                      <dl>
                        <dt>施術名</dt>
                ...
                <article>
                  <a class="fl-style04-fl d-fl" target="_blank" rel="nofollow noreferrer">
                    <figure>
                      <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/case/eye-case02.png" alt="症例写真">
                    </figure>
                    <div class="content">
                      <dl>
                        <dt>施術名</dt>
                ...
                <article>
                  <a class="fl-style04-fl d-fl" target="_blank" rel="nofollow noreferrer">
                    <figure>
                      <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/case/eye-case03.png" alt="症例写真">
                    </figure>
                    <div class="content">
                      <dl>
                        <dt>施術名</dt>
            ...
            <div class="sl-price-inn-content">
              ...
              <div class="price">
                ...
                <div class="price-list">
                  ...
                  <p class="price-list-warn">※アイライン跳ね上げ: 古谷のみ<br>※指名料: 11,000円</p>
                </div>
              </div>
            </div>
          </div>
