          ...
          <div class="sl-whatis-inn menu-inn attach-mv">
            ...
            <div class="sl-whatis-inn-content">
              <div class="fl-style02 d-fl">
                <div class="image">
                  <img loading="lazy" class="pc" src="<?php echo get_template_directory_uri(); ?>/img/sub-whatpeeling-img01.png" alt="ピーリングとは">
                  <img loading="lazy" class="sp" src="<?php echo get_template_directory_uri(); ?>/img/sub-whatpeeling-img01-sp.png" alt="ピーリングとは">
                </div>
                <div class="content">
            ...
            <div class="sv-info">
                ...
                <div class="doctor__comments">
                  ...
                  <p>
                    リアンクリニックでは
                    <br>▶エイジングケアが出来る『マッサージピール』
                    <br>▶毛穴に効果のある『ミラノリピール』
                    <br>の2つのピーリング剤をご用意しております。
                    <br>
                    <br>肌の悩みに応じてピーリング剤を選ぶのがおすすめです。
                    <br>
                    <br>リアン式では薬剤の塗布方法が特殊。気になる毛穴や、リフティングさせたい箇所にアプローチさせる手技で施術を行います。
                  </p>
                </div>
        ...
        <div id="treatment" class="sl-treatment">
          <div class="menu-inn sl-treatment-inn">
            ...
            <div class="sl-treatment-inn-content">
              <div class="fl-style02 d-fl">
                <div class="image">
                  <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/treatment/treatment06.png" alt="エレクトロポレーション">
                </div>
