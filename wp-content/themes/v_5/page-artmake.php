    ...
    <div id="menu"  class="sl-menu menu-artmarke">
      <div class="sl-menu-content">
          ...
          <div class="sl-whatis-inn menu-inn attach-mv">
            ...
            <div class="sl-whatis-inn-content">
              <div class="d-fl whatis-detailup">
                <figure>
                  <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/makeup/sub-whatis-img.png" alt="アートメイクとは">
                </figure>
              ...
              <div class="d-fl whatis-detailbot">
                ...
                <figure>
                  <img loading="lazy" class="pc" src="<?php echo get_template_directory_uri(); ?>/img/sub-whatis-img-02.jpg"
                    alt="アートメイクとは">
                  <img loading="lazy" class="sp" src="<?php echo get_template_directory_uri(); ?>/img/sub-whatis-img-sp-02.png"
                    alt="アートメイクとは">
                </figure>
              </div>
            </div>
            ...
            <div class="sv-info">
                ...
                <div class="doctor__comments">
                  ...
                  <p>
                    眉は印象を変える重要なパーツです。当院では3Dと4Dブロウを組み合わせてた技法を用いて、自然な眉に仕上げております。アートメイク看護師はすべて3000例以上経験しているトップアーティストのみ所属しております。メイクが面倒という方、素顔に自信がない方などはぜひ当院のアートメイクをご経験ください。
                  </p>
                </div>
        ...
        <div id="dyh" class="sl-dyh">
          <div class="menu-inn sl-dyh-inn">
            ...
            <div class="sl-dyh-inn-content">
              <figure>
                <img loading="lazy" class="pc" src="<?php echo get_template_directory_uri(); ?>/img/menu/menu-links.png" alt="menu">
                <img loading="lazy" class="sp" src="<?php echo get_template_directory_uri(); ?>/img/sub-dyh-bg.jpg" alt="menu">
              </figure>
              <figure class="sp menu-links-sp">
                <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/menu/menu-links_sp.png" alt="menu">
              </figure>
            </div>
          </div>
        </div>
              ...
              <div class="fl-style01">
                <article class="fl-style01-item">
                  ...
                  <div class="d-fl fl-style01-item-content">
                    <figure>
                      <img loading="lazy" class="pc" src="<?php echo get_template_directory_uri(); ?>/img/benefits/benefits-img-01.png"
                        alt="お出かけ前のメイク時間の短縮">
                      <img loading="lazy" class="sp" src="<?php echo get_template_directory_uri(); ?>/img/benefits/benefits-img-01-sp.png"
                        alt="お出かけ前のメイク時間の短縮">
                    </figure>
                    <div class="fl-style01-item-content-txt">
                      <p>これまで毎日メイクにかけていた時間がアートメイクをすることで大きく短縮されます。<br>
                      洗顔が完了したメイク前の段階で、すでに眉毛が完成していると想像すると、これだけでもかなりの手間が省けることは想像できるのではないでしょうか。特に普段メイクに時間のかかる部分にアートメイクをしておくことで、<u>準備にかける時間は大幅に減り</u>、<span class="color-02"><strong>毎朝のストレスから解放されます。</strong></span>
                      </p>
                    </div>
                  </div>
                </article>
                <article class="fl-style01-item">
                  ...
                  <div class="d-fl fl-style01-item-content">
                    <figure>
                      <img loading="lazy" class="pc" src="<?php echo get_template_directory_uri(); ?>/img/benefits/benefits-img-02.png"
                        alt="メイクのテクニックが不要に">
                      <img loading="lazy" class="sp" src="<?php echo get_template_directory_uri(); ?>/img/benefits/benefits-img-02-sp.png"
                        alt="メイクのテクニックが不要に">
                    </figure>
                    <div class="fl-style01-item-content-txt">
                ...
                <article class="fl-style01-item">
                  ...
                  <div class="d-fl fl-style01-item-content">
                    <figure>
                      <img loading="lazy" class="pc" src="<?php echo get_template_directory_uri(); ?>/img/benefits/benefits-img-03.png"
                        alt="メイク崩れの不安解消">
                      <img loading="lazy" class="sp" src="<?php echo get_template_directory_uri(); ?>/img/benefits/benefits-img-03-sp.png"
                        alt="メイク崩れの不安解消">
                    </figure>
                    <div class="fl-style01-item-content-txt">
                      <p>
            ...
            <div class="sl-recommended-inn-content">
              ...
              <div class="fl-style01">
                <article class="fl-style01-item">
                  ...
                  <div class="d-fl fl-style01-item-content">
                    <figure>
                      <img loading="lazy" class="pc" src="<?php echo get_template_directory_uri(); ?>/img/recommend/recommend-img-01.png"
                        alt="素顔に自信を持ちたい方">
                      <img loading="lazy" class="sp" src="<?php echo get_template_directory_uri(); ?>/img/recommend/recommend-img-01-sp.png"
                        alt="素顔に自信を持ちたい方">
                    </figure>
                    <div class="fl-style01-item-content-txt">
                      <p>
                        アートメイクを施すことで、常に理想の眉でいられるため、<u>自分の素顔に自信を持つことができます。</u>自分に合う理想の眉が分からないという方でも、<u>アートメイクの看護師がご自身に合った眉を提案</u>してもらえるため安心です。<br>
                ...
                <article class="fl-style01-item">
                  ...
                  <div class="d-fl fl-style01-item-content">
                    <figure>
                      <img loading="lazy" class="pc" src="<?php echo get_template_directory_uri(); ?>/img/recommend/recommend-img-02.png"
                        alt="メイクに時間をかけたくない方">
                      <img loading="lazy" class="sp" src="<?php echo get_template_directory_uri(); ?>/img/recommend/recommend-img-02-sp.png"
                        alt="メイクに時間をかけたくない方">
                    </figure>
                    <div class="fl-style01-item-content-txt">
                ...
                <article class="fl-style01-item">
                  ...
                  <div class="d-fl fl-style01-item-content">
                    <figure>
                      <img loading="lazy" class="pc" src="<?php echo get_template_directory_uri(); ?>/img/recommend/recommend-img-03.png"
                        alt="スポーツをされている方">
                      <img loading="lazy" class="sp" src="<?php echo get_template_directory_uri(); ?>/img/recommend/recommend-img-03-sp.png"
                        alt="スポーツをされている方">
                    </figure>
                    <div class="fl-style01-item-content-txt">
          ...
          <div class="menu-inn sl-features-inn">
            ...
            <div class="sl-features-inn-content">
              <article class="d-fl sl-features-inn-content-article">
                <figure>
                  <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/features/feature-img.png" alt="feature">
                </figure>
              ...
              <div class="fl-style01">
                <article class="fl-style01-item">
                  <h2 class="fl-style01-item-ttl"><span class="list-no">01</span>ヒアリング <img loading="lazy" class="title-cross"
                      src="<?php echo get_template_directory_uri(); ?>/img/ttl-cross.png"> 提案力
                  </h2>
                  <div class="d-fl fl-style01-item-content">
                    <figure>
                      <img loading="lazy" class="pc" src="<?php echo get_template_directory_uri(); ?>/img/features/feature-01.png"
                        alt="features">
                      <img loading="lazy" class="sp" src="<?php echo get_template_directory_uri(); ?>/img/features/feature-01-sp.png"
                        alt="features">
                    </figure>
                    <div class="fl-style01-item-content-txt">
                ...
                <article class="fl-style01-item">
                  ...
                  <div class="d-fl fl-style01-item-content">
                    <figure>
                      <img loading="lazy" class="pc" src="<?php echo get_template_directory_uri(); ?>/img/features/feature-02.png"
                        alt="features">
                      <img loading="lazy" class="sp" src="<?php echo get_template_directory_uri(); ?>/img/features/feature-02-sp.png"
                        alt="features">
                    </figure>
                    <div class="fl-style01-item-content-txt">
                      <p>LIANクリニックでは<span class="color-02"><strong>1000例以上のアーティストしか在籍しておりません。</strong></span><br>
                      アートメイクでは経験が物を言う施術です。お客様の幅広い要望を実現するために、施術経験が少ない・コミュニケーション力が低いアーティストはお断りしております。経験豊富なアーティストよりお客様に最適なデザインをご提案させていただきますので、ご安心ください。
                      </p>
                    </div>
                  </div>
                </article>
                <article class="fl-style01-item">
                  <h2 class="fl-style01-item-ttl"><span class="list-no">03</span>2種類の麻酔で痛みを抑えた施術</h2>
                  <div class="d-fl fl-style01-item-content">
                    <figure>
                      <img loading="lazy" class="pc" src="<?php echo get_template_directory_uri(); ?>/img/features/feature-03.png"
                        alt="features">
                      <img loading="lazy" class="sp" src="<?php echo get_template_directory_uri(); ?>/img/features/feature-03-sp.png"
                        alt="features">
                    </figure>
                    <div class="fl-style01-item-content-txt">
                      <p>通常のクリニックでは１種類の麻酔を使用するのが一般的ですが、LIANクリニックではアートメイクの施術の際に2種類の麻酔を使用し、<span class="color-02"><strong>極力痛みを抑えた施術を実現</strong></span>しています。
              ...
              <div class="fl-style04">
                <article>
                  <a class="fl-style04-fl d-fl" target="_blank" rel="nofollow noreferrer">
                    <figure>
                      <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/case/case-01.png" alt="症例写真">
                    </figure>
                    <div class="content">
                      <dl>
                        <dt>施術名</dt>
                ...
                <article>
                  <a class="fl-style04-fl d-fl" target="_blank" rel="nofollow noreferrer">
                    <figure>
                      <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/case/case-02.png" alt="症例写真">
                    </figure>
                    <div class="content">
                      <dl>
                        <dt>施術名</dt>
                ...
                <article>
                  <a class="fl-style04-fl d-fl" target="_blank" rel="nofollow noreferrer">
                    <figure>
                      <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/case/case-03.png" alt="症例写真">
                    </figure>
                    <div class="content">
                      <dl>
                        <dt>施術名</dt>
            ...
            <div class="sl-procedure-inn-content pro-list">
              ...
              <div class="d-fl pro-list-post">
                ...
                <article class="d-fl">
                  ...
                  <figure>
                    <img loading="lazy" class="pc" src="<?php echo get_template_directory_uri(); ?>/img/procedure/procedure-01.png"
                      alt="ヒアリング">
                    <img loading="lazy" class="sp" src="<?php echo get_template_directory_uri(); ?>/img/procedure/procedure-01-sp.png"
                      alt="ヒアリング">
                  </figure>
                  <div>
              ...
              <div class="d-fl pro-list-post">
                ...
                <article class="d-fl">
                  ...
                  <figure>
                    <img loading="lazy" class="pc" src="<?php echo get_template_directory_uri(); ?>/img/procedure/procedure-02.png"
                      alt="デッサンにてデザイン確認">
                    <img loading="lazy" class="sp" src="<?php echo get_template_directory_uri(); ?>/img/procedure/procedure-02-sp.png"
                      alt="デッサンにてデザイン確認">
                  </figure>
                  <div>
              ...
              <div class="d-fl pro-list-post">
                ...
                <article class="d-fl">
                  ...
                  <figure>
                    <img loading="lazy" class="pc" src="<?php echo get_template_directory_uri(); ?>/img/procedure/procedure-03.png"
                      alt="デザインのすり合わせ">
                    <img loading="lazy" class="sp" src="<?php echo get_template_directory_uri(); ?>/img/procedure/procedure-03-sp.png"
                      alt="デザインのすり合わせ">
                  </figure>
                  <div>
              ...
              <div class="d-fl pro-list-post">
                ...
                <article class="d-fl">
                  ...
                  <figure>
                    <img loading="lazy" class="pc" src="<?php echo get_template_directory_uri(); ?>/img/procedure/procedure-04.png"
                      alt="麻酔">
                    <img loading="lazy" class="sp" src="<?php echo get_template_directory_uri(); ?>/img/procedure/procedure-04-sp.png"
                      alt="麻酔">
                  </figure>
                  <div>
                    <h3 class="pc">麻酔</h3>
              ...
              <div class="d-fl pro-list-post">
                ...
                <article class="d-fl">
                  ...
                  <figure>
                    <img loading="lazy" class="pc" src="<?php echo get_template_directory_uri(); ?>/img/procedure/procedure-05.png"
                      alt="施術">
                    <img loading="lazy" class="sp" src="<?php echo get_template_directory_uri(); ?>/img/procedure/procedure-05-sp.png"
                      alt="施術">
                  </figure>
                  <div>
                    <h3 class="pc">施術</h3>
              ...
              <div class="d-fl pro-list-post">
                ...
                <article class="d-fl">
                  ...
                  <figure>
                    <img loading="lazy" class="pc" src="<?php echo get_template_directory_uri(); ?>/img/procedure/procedure-06.png"
                      alt="アフターケア">
                    <img loading="lazy" class="sp" src="<?php echo get_template_directory_uri(); ?>/img/procedure/procedure-06-sp.png"
                      alt="アフターケア">
                  </figure>
                  <div>
                    <h3 class="pc">アフターケア</h3>
                    <p>施術後のアフターケアはとても重要です。まずは<span class="color-02"><strong>1週間水に濡らさない</strong></span>ようにしましょう。施術部位に毎日ワセリンを塗布し乾燥を防ぎます。3日程度で皮が剥けますが、この間も触らないように気をつけましょう。<br>
          ...
          <div class="menu-inn sl-differences-inn">
            ...
            <div class="sl-differences-inn-content">
              ...
              <div class="diff-wr">
                <article class="d-fl">
                  <figure>
                    <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/differences/differences-01.jpg"
                      alt="differences">
                  </figure>
                  <div>
                ...
                <article class="d-fl">
                  <figure>
                    <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/differences/differences-02.jpg"
                      alt="differences">
                  </figure>
                  <div>
                ...
                <article class="d-fl">
                  <figure>
                    <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/differences/differences-03.jpg"
                      alt="differences">
                  </figure>
                  <div>
            ...
            <div class="sl-price-inn-content">
              <div class="price">
                ...
                <div class="price-list">
                  ...
                  <p class="price-list-warn">※指名料：11,000円</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div id="instagram" class="sl-instagram">
          <div class="menu-inn sl-instagram-inn">
            ...
            <div class="sl-instagram-inn-sns">
              <ul class="d-fl">
                <li>
                  <a href="https://www.instagram.com/medbeauty.artmake/" rel="alternate" target="_blank"><img loading="lazy"
                ...
                <li>
                  <a href="https://youtube.com/channel/UCEHr4nCFMhBi8e2PkEYmYAw" rel="alternate" target="_blank"><img loading="lazy"
                      src="<?php echo get_template_directory_uri(); ?>/img/iconb-yt.png" alt=""></a>
                </li>
                <li>
                  <a href="https://www.tiktok.com/@lianclinic?_t=8UsHNwdliM6&_r=1" rel="alternate" target="_blank"><img loading="lazy"
        ...
        <div id="connection" class="">
          <div class="menu-inn">
            <div class="sl-connection-inn-ttl subpage-ttl menu-inn-ttl "><h2 class="under-line">素顔の改善に効果的な治療</h2></div>
            <div class="sl-connection-inn-content">

              <?php get_template_part('template-parts/service/artmake-lip'); ?>
              <?php get_template_part('template-parts/service/artmake-eyeline'); ?>
