...
<script type="application/ld+json">
  {
    ...
    "mainEntity": [{
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "<span>カベリン・プラスは腫れを極力抑える成分構成になっていますが、腫れ・むくみは1週間ほど続きます。あざもできることはほとんどありませんが、できた場合でも1，2週間で治まります。</span>"
        }
      },
      {
        "@type": "Question",
        ...
        <div id="whatis" class="sl-whatis">
          <div class="sl-whatis-inn menu-inn attach-mv">
            <div class="sl-whatis-inn-ttl subpage-ttl menu-inn-ttl">
              <h1 class="under-line menu-inn-ttl__inner">脂肪溶解注射 カベリン</h1>
            </div>
            <div class="sl-whatis-inn-content">
              <div class="fl-style02 d-fl align-center">
                <div class="image">
                  <img loading="lazy" class="pc" src="<?php echo get_template_directory_uri(); ?>/img/sub-whatfatdis-img01.png" alt="脂肪溶解注射 チンセラ">
                  <img loading="lazy" class="sp" src="<?php echo get_template_directory_uri(); ?>/img/sub-whatfatdis-img01-sp.png" alt="脂肪溶解注射 チンセラ">
                </div>
                <div class="content">
                  <p>
              ...
              <div class="sv-info">
                ...
                <div class="doctor__comments">
                  ...
                  <p>カベリン（Kabelline）は、脂肪を分解して体外に排出する注射による痩身治療です。脂肪溶解成分がBNLSneoの約5000倍で、従来の脂肪溶解注射と比べて高い痩身効果があります。腫れや痛みを抑えることもできます</p>
                </div>
          ...
          <div class="menu-inn sl-treatment-inn">
            ...
            <div class="sl-treatment-inn-content">
              <div class="fl-style02 d-fl">
                <div class="image">
                  <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/img/treatment/treatment01.png" alt="HIFUリニア">
                </div>
        ...
        <div id="price" class="sl-price">
          <div class="menu-inn sl-price-inn">
            ...
            <div class="sl-price-inn-content">
              <div class="price">
                <h3 class="price-ttl"><span>脂肪溶解注射<br class="sp">(カベリン)</span></h3>
        ...
        <div id="precautions" class="sl-precautions">
          <div class="menu-inn sl-precautions-inn">
            ...
            <div class="sl-precautions-inn-content">
              ...
              <div class="pg-text">
                <p>注入部位は腫れや痛み、内出血が出現する場合がありますが、時間の経過とともに改善します。腫れが引くと同時に硬さが出てくる場合もありますが、1ヶ月程度で改善します。<br>また、処置当日の入浴（シャワー可）、飲酒はお控えください。痛みや腫れを助長する可能性があります。赤みや腫れの持続、蕁麻疹の出現などがある場合は、アレルギーなどの可能性がございますので、早めに当院医師の診察をお受けください。</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div id="connection" class="">
          <div class="menu-inn">
            ...
            <div class="sl-connection-inn-content">
                ...
                <?php get_template_part('template-parts/service/hifu-linear'); ?>
