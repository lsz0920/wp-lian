...
<head>
	...
	<link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/css/style.min.css?v=1.2.0<?= rand() ?>"
		rel="preload" as="style" onload="this.onload=null;rel='stylesheet'">
					...
					<ul class="d-fl">
							...
							<ul class="submenu-list pc">
								<li class="sub-parent">
									...
									<ul class="submenu--list">
										<li><a href="<?php echo esc_html(home_url('/')) ?>menu/artmake">眉<br>アートメイク</a>
										</li>
										<li><a
												href="<?php echo esc_html(home_url('/')) ?>menu/artmake-lip">リップ<br>アートメイク</a>
										</li>
										<li><a
												href="<?php echo esc_html(home_url('/')) ?>menu/artmake-eyeline">アイライン<br>アートメイク</a>
										</li>
									</ul>
								</li>
								<li class="sub-parent">
									...
									<ul class="submenu--list">
										...
										<li><a
												href="<?php echo esc_html(home_url('/')) ?>menu/liftup-botox">リフトアップ<br>ボトックス</a>
										</li>
										<li><a href="<?php echo esc_html(home_url('/')) ?>menu/thread">ショートスレッド</a></li>
										<li><a
												href="<?php echo esc_html(home_url('/')) ?>menu/hyaluronic/">ヒアルロン酸注入</a>
										</li>
									</ul>
								</li>
								<li class="sub-parent">
									...
									<ul class="submenu--list">
										<li><a
												href="<?php echo esc_html(home_url('/')) ?>menu/potenza">ポテンツァ</a>
										</li>
								...
								<li class="sub-parent">
									...
									<ul class="submenu--list">
										...
										<li><a
												href="<?php echo esc_html(home_url('/')) ?>menu/fat-dissolve">脂肪溶解注射<br>カベリン</a>
										</li>
									</ul>
								</li>
								...
								<li class="sub-parent">
									...
									<span class="sub-toggle"></span>
									<ul class="submenu--list">
										<li><a href="https://lianclinic.net/exosomes/">エクソソーム</a>
										</li>
									</ul>
								</li>
						...
						<li class="sub-parent sp">
							...
							<ul class="submenu--list">
								<li><a href="<?php echo esc_html(home_url('/')) ?>menu/hifu">- HIFU</a></li>
								<li><a href="<?php echo esc_html(home_url('/')) ?>menu/sarmagen">- サーマジェン</a></li>
								<li><a href="<?php echo esc_html(home_url('/')) ?>menu/liftup-botox">- リフトアップボトックス</a>
								</li>
								<li><a href="<?php echo esc_html(home_url('/')) ?>menu/thread">- ショートスレッド</a></li>
						...
						<li class="sub-parent sp">
							...
							<ul class="submenu--list">
								<li><a href="<?php echo esc_html(home_url('/')) ?>menu/botox">- ボトックス</a></li>
								<li><a href="<?php echo esc_html(home_url('/')) ?>menu/fat-dissolve">- 脂肪溶解注射 カベリン</a>
								</li>
							</ul>
						</li>
						<li class="sub-parent sp">
							...
							<span class="sub-toggle"></span>
							<ul class="submenu--list">
								<li><a href="<?php echo esc_html(home_url('/')) ?>menu/potenza">- ポテンツァ</a>
								</li>
								<li><a href="<?php echo esc_html(home_url('/')) ?>menu/peeling">- ピーリング</a></li>
								<li><a href="<?php echo esc_html(home_url('/')) ?>menu/photoipl">- フォトipl</a></li>
							</ul>
						...
						<li class="sub-parent sp">
							...
							<ul class="submenu--list">
								...
								<li><a href="<?php echo esc_html(home_url('/')) ?>menu/artmake-lip">- リップ<br>アートメイク</a>
								</li>
								<li><a href="<?php echo esc_html(home_url('/')) ?>menu/artmake-eyeline">-
										アイライン<br>アートメイク</a></li>
							</ul>
						</li>
						<li class="sub-parent sp">
							<a><small>エクソソーム</small></a>
							<span class="sub-toggle"></span>
							<ul class="submenu--list">
						...
						<div class="sp">
							<div class="hd-snsList">
								...
								<a href="https://www.youtube.com/channel/UCV6Z_OcNaYcUz2cwjaqlg1w/featured"
									rel="alternate" target="_blank"><img
										src="<?php echo get_template_directory_uri(); ?>/img/iconb-yt.png" alt=""></a>
								<a href="https://www.tiktok.com/@medbeautyartmake" rel="alternate" target="_blank"><img
