...
// 各種メニューのパンクズリストを拡張してサービスへのリンクを追加する
function override_yoast_breadcrumb($links)
{
	if (is_page(
		['artmake', 'artmake-lip', 'artmake-eyeline', 'hifu', 'hifu-linear', 'sarmagen', 'liftup-botox', 'thread', 'needle-rf', 'peeling', 'photoipl', 'botox', 'hifu-linear', 'fat-dissolve']
	)) {
