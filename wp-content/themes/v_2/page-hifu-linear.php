...
<script type="application/ld+json">
  {
    ...
    "mainEntity": [{
      ...
      {
        "@type": "Question",
        "name": "ウルトラセルQプラス、リニアはたるみの引き締め効果は無いのですか？",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "<span>ウルトラセルQプラスは、点照射・線照射によって治療効果が異なります。線照射のリニアは、広範囲に熱を伝えることで脂肪を溶解する効果があります。</span>"
        }
      },
      {
        "@type": "Question",
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "<span>副作用はほとんどありませんが、照射中に熱感を感じることはあります。また、照射後に赤みの出る方もいらっしゃいます。</span>"
        }
      },
      {
        "@type": "Question",
        ...
        <div id="whatis" class="sl-whatis">
          <div class="sl-whatis-inn menu-inn attach-mv">
            <div class="sl-whatis-inn-ttl subpage-ttl menu-inn-ttl">
              <h1 class="under-line menu-inn-ttl__inner">HIFUリニア<br class="sp"> (脂肪溶解HIFU) とは</h1>
            </div>
