          ...
          <div class="sl-whatis-inn menu-inn attach-mv">
            ...
            <div class="sl-whatis-inn-content">
              <div class="fl-style02 d-fl align-center">
                <div class="image">
                  <img class="pc" src="<?php echo get_template_directory_uri(); ?>/img/sub-whatliftup-img01.png" alt="リフトアップボトックスとは">
                  <img class="sp" src="<?php echo get_template_directory_uri(); ?>/img/sub-whatliftup-img01-sp.png" alt="リフトアップボトックスとは">
                </div>
                <div class="content">
                  <p>
                    リフトアップボトックスとは、広頸筋、口角下制筋、オトガイ筋にボトックスを効かせることで顎の梅干しジワの改善、口角をきゅっと上げ、首の縦じわが改善することが可能です。<br>
                    年齢の出やすい下顔面のもたつきがスッキリし、エイジングケアが出来る施術です。
                  </p>
                </div>
              </div>
          ...
          <div class="menu-inn sl-reservation-inn">
            ...
            <div class="sl-reservation-inn-content">
              <div class="reservation-wr">
                ...
                <a href="https://reservation.medical-force.com/2d96f6933ed14b2a8e271863a7f0b813/reservations/new?menu_ids=d8fefe51-50fc-4550-96bf-c32d2ec44728" target="_blank" rel="nofollow noreferrer">
