...
<head>
  ...
  <!-- Google Tag Manager -->
	...
	})(window,document,'script','dataLayer','GTM-5LC2HXL');</script>
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/slick-carousel/1.8.1/slick.min.css" rel="preload"
    as="style">
      ...
      <div class="l-hd-inn d-fl">
        ...
        <nav class="l-hd-inn-nav">
          <ul class="d-fl">
            ...
            <li class="sp"><a
                href="<?php echo esc_html( home_url('/') ) ?>menu/thread"><small>ショートスレッド</small></a></li>
            ...
            <div class="sp">
              <div class="hd-snsList">
                ...
                <a href="https://www.youtube.com/channel/UCV6Z_OcNaYcUz2cwjaqlg1w/featured" rel="alternate"
                  target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/img/iconb-yt.png" alt=""></a>
