        ...
        <div id="whatis" class="sl-whatis">
          <div class="menu-inn sl-whatis-inn attach-mv">
            <div class="sl-whatis-inn-ttl subpage-ttl menu-inn-ttl">
              <h2 class="under-line">アイラインアートメイクとは</h2>
            </div>
            <div class="sl-whatis-inn-content">
              ...
              <div class="d-fl whatis-detailbot">
                ...
                <figure>
                  <img class="pc" src="<?php echo get_template_directory_uri(); ?>/img/sub-whatislip-img02.jpg"
                    alt="アートメイクは皮膚のごく浅い部分である表皮に色素を注入">
                  <img class="sp" src="<?php echo get_template_directory_uri(); ?>/img/sub-whatislip-img02-sp.png"
                    alt="アートメイクは皮膚のごく浅い部分である表皮に色素を注入">
                </figure>
              </div>
            </div>
              ...
              <div class="fl-style01">
                <article class="fl-style01-item">
                  ...
                  <div class="d-fl fl-style01-item-content">
                    <figure>
                      <img src="<?php echo get_template_directory_uri(); ?>/img/benefits/eyeliner-benefits-img01.png"
                        alt="目力UP">
                    </figure>
                ...
                <article class="fl-style01-item">
                  ...
                  <div class="d-fl fl-style01-item-content">
                    <figure>
                      <img src="<?php echo get_template_directory_uri(); ?>/img/benefits/eyeliner-benefits-img02.png"
                        alt="アイメイクのテクニックが">
                    </figure>
                    <div class="fl-style01-item-content-txt">
                ...
                <article class="fl-style01-item">
                  ...
                  <div class="d-fl fl-style01-item-content">
                    <figure>
                      <img src="<?php echo get_template_directory_uri(); ?>/img/benefits/eyeliner-benefits-img03.png"
                        alt="メイク時間を大幅に短縮">
                    </figure>
                    <div class="fl-style01-item-content-txt">
                ...
                <article class="fl-style01-item">
                  ...
                  <div class="d-fl fl-style01-item-content">
                    <figure>
                      <img src="<?php echo get_template_directory_uri(); ?>/img/benefits/eyeliner-benefits-img04.png"
                        alt="すっぴんに抵抗がなくなる">
                    </figure>
                    <div class="fl-style01-item-content-txt">
            ...
            <div class="sl-failcase-inn-content">
              ...
              <div class="disc-list">
                <ul class="disc-list-wr">
                  <li class="d-fl"><span>・</span><p>除去するには特殊な施術（レーザー除去）が必要</p></li>
                  <li class="d-fl"><span>・</span><p>自然に消えるまでに長い期間がかかる</p></li>
                </ul>
              </div>
              <div class="pg-text">
                <p>となります。<br>
            ...
            <div class="sl-clinic-inn-content">
              ...
              <div class="fl-style01">
                <article class="fl-style01-item">
                  ...
                  <div class="d-fl fl-style01-item-content">
                    <figure>
                      <img src="<?php echo get_template_directory_uri(); ?>/img/eyeline/eyeliner-howto-img01.png"
                        alt="カウンセリングを">
                    </figure>
                    <div class="fl-style01-item-content-txt">
                ...
                <article class="fl-style01-item">
                  ...
                  <div class="d-fl fl-style01-item-content">
                    <figure>
                      <img src="<?php echo get_template_directory_uri(); ?>/img/eyeline/eyeliner-howto-img02.png"
                        alt="実績が多く症例写真を">
                    </figure>
                    <div class="fl-style01-item-content-txt">
                ...
                <article class="fl-style01-item">
                  ...
                  <div class="d-fl fl-style01-item-content">
                    <figure>
                      <img src="<?php echo get_template_directory_uri(); ?>/img/eyeline/eyeliner-howto-img03.png"
                        alt="アフターフォローが">
                    </figure>
                    <div class="fl-style01-item-content-txt">
                      <p>
                        <span class="color-02"><strong>アートメイクはアイラインに限らずどの部位であっても、1度の施術では完成しないことがほとんどです。</strong></span>これは、皮膚のターンオーバーにより、初回の施術で注入した色素が抜け落ちてしまうためです。<br
                          class="sp">
          ...
          <div class="menu-inn sl-reservation-inn">
            ...
            <div class="sl-reservation-inn-content">
              <div class="reservation-wr">
                ...
                <a href="https://reservation.medical-force.com/2d96f6933ed14b2a8e271863a7f0b813/reservations/new?menu_ids=598a2340-551c-4a95-a6b4-986a39d39e22" target="_blank" rel="nofollow noreferrer">
